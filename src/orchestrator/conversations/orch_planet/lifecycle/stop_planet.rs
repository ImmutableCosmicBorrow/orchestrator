...
fn wait_planet_stop_res_transition(this: Box<StopPlanetConversation<WaitingPlanetStopResult>>, msg: Option<PossibleMessage>) -> Option<Box<dyn Conversation + Send + Sync>> {
