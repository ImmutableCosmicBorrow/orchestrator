...
use crate::orchestrator::conversations::{SendersToExplorer, SendersToPlanet, ToExplorerStruct, ToPlanetStruct};
...
#[cfg(test)]
pub(crate) fn make_to_explorer_struct(explorer_id: ID, senders: SendersToExplorer) -> ToExplorerStruct {
    ToExplorerStruct {
        explorer_id,
