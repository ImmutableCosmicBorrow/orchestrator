...
fn wait_craft_resource_res_transition(this: Box<CraftResourceConversation<WaitingCraftResourceResult>>, msg: Option<PossibleMessage>) -> Option<Box<dyn Conversation + Send + Sync>> {
